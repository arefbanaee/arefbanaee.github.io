...
const about = props => (
  <div>
    ...
    <p style={{ textIndent: "3rem" }}>
      ...
      <Bold_content content=" Joint Replacement" />
      , <Bold_content content=" Orthopaedic Implant Design" />, and{" "}
      <Bold_content content=" Finite Element Analysis" /> in
      <Bold_content content=" Orthopaedic Biomechanics" />. I am particularly
