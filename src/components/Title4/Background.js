    ...
    function() {
      ...
      var step = function() {
        ...
        t_NodesJs.nodes.forEach(function(_node, _node_i) {
          ...
          ctx.beginPath();
          ctx.arc(_node[0], _node[1], 2, 0, Math.PI * 2, true);
          ctx.fill();
    ...
    <div>
      <script type="text/javascript">
        ...
        {{
          ...
          backgroundFrom: [113, 143, 140],
          backgroundTo: [10, 54, 50],
      ...
      <div style="width: 100%; position: absolute; left: 0px; top: 0px; overflow: hidden; width: 100%; height: 100%;">
        <canvas id="nodes" />
      </div>
    </div>
  );
